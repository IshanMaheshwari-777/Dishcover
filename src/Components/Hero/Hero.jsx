...
const Hero = () => {
  return (
    <div
      className="w-full h-[65vh] bg-cover bg-center text-white flex flex-col md:flex-row justify-between items-center px-6 md:px-12 py-8"
    ...
    >
      ...
      <div className="max-w-md mt-10 md:mt-0 md:ml-10 bg-black/70 backdrop-blur-sm p-6 rounded-xl shadow-2xl border border-gray-700">
